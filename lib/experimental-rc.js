...
const isRc_ = testAnd(isDeinitable, {deref: isFunction, clone: isFunction, weak: isFunction})
...
const isWeak_ = test({deref: isFunction, isEmpty: isFunction, clone: isFunction, rc: isFunction})
