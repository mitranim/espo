...
class Observable {
  constructor () {
    ...
    this.subscriptions = []
    this.que = new Que(triggerAllSubscriptions.bind(this))
  }
...
function triggerAllSubscriptions (args) {
  forceEach(this.subscriptions, triggerOneSubscription, args)
}

function triggerOneSubscription (subscription, args) {
